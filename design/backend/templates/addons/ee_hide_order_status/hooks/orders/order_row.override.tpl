<tr class="cm-longtap-target"
            ...
            >
                ...
                {$order_statuses = $order_statuses|fn_ee_hide_order_status_change_status:$o.status}
                {$order_status_descr = $order_status_descr|fn_ee_hide_order_status_change_status:$o.status}				
